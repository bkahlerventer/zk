...
import zk.zookeeper.{CreateMode, KeeperException, Watcher, WatchedEvent, ZooKeeper}
import zk.zookeeper.data.{ACL, Stat, Id}
import zk.zookeeper.ZooDefs.Ids
import zk.zookeeper.Watcher.Event.EventType
import zk.zookeeper.Watcher.Event.KeeperState
...
object ZooKeeperClient {
  private val log = Logger(LoggerFactory.getLogger(ZooKeeperClient.getClass))
}