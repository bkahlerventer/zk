...
public class ClientCnxnSocketNetty extends ClientCnxnSocket {
    ...
    //ChannelFactory channelFactory = new NioSocketChannel(
    ...
    void connect(InetSocketAddress addr) throws IOException {
        ...
        bootstrap.handler(new ZKInitializer(addr.getHostString(), addr.getPort()));
    ...
    private class ZKInitializer extends ChannelInitializer<Channel> {
        private SSLContext sslContext = null;
        private SSLEngine sslEngine = null;
        private String host;
        private int port;

        ZKInitializer(String host, int port) {
            this.host = host;
            this.port = port;
        }
        ...
        private synchronized void initSSL(Channel channel) throws SSLContextException {
            ChannelPipeline pipeline = channel.pipeline();
            ...
            LOG.info("SSL handler added for channel: {}", channel);
        }
    }
