...
public class NettyServerCnxn extends ServerCnxn {
    ...
    public void close() {
        ...
        synchronized(factory.cnxns){
            ...
            synchronized (factory.ipMap) {
                Set<NettyServerCnxn> s = factory.ipMap.get(((InetSocketAddress)channel.remoteAddress()));
                s.remove(this);
            }
        }
    ...
    // TODO - MessageDecoder??? used to extend MessageEvent
...
// TODO - ConnectionWatchDog extends SimpleChannelUpstreamHandler
    @Override
    public void enableRecv() {
        if (throttled) {
            ...
            //channel.pipeline().sendUpstream(new ResumeMessageEvent(channel));
        }
    }
